import { bulletWallCollisions, bulletPlayerCollisions, determinePlayerMovement, } from "./backend/physics.js";
...
io.on("connection", (socket) => {
    ...
    socket.on("serverUpdateSelf", (playerData) => {
        ...
        if (!player || player.health <= 0) {
            ...
            players[playerData.id] = Object.assign(Object.assign({}, playerData), { health: 100, x: spawnPoint[0], y: spawnPoint[1] });
            return;
        }
        const playerBounds = {
            x: player.x,
        ...
        bulletPlayerCollisions(io, socket, bullets, players, playerData, playerBounds);
