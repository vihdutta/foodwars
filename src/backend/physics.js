...
export function determinePlayerMovement(player, playerBounds, playerData, walls) {
    ...
    Object.entries(walls).forEach(([wallId, wall]) => {
        if (checkCollision(wall, Object.assign(Object.assign({}, playerBounds), { y: playerBounds.y - speed }))) {
            canMoveUp = false;
        }
        if (checkCollision(wall, Object.assign(Object.assign({}, playerBounds), { x: playerBounds.x - speed }))) {
            canMoveLeft = false;
        }
        if (checkCollision(wall, Object.assign(Object.assign({}, playerBounds), { y: playerBounds.y + speed }))) {
            canMoveDown = false;
...
export function bulletPlayerCollisions(io, socket, bullets, players, playerData, playerBounds) {
