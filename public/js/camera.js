...
export function hideSpritesOutsideScreen(app) {
    ...
    app.stage.children.forEach((sprite) => {
        ...
        const isVisible = spriteBounds.x + spriteBounds.width > 0 &&
...
export function updateCamera(app, player, widthForHealthBar, camera, UIElements, dimRectangle, coordinatesText, FPSText, socketText, inventory, healthBar, healthBarValue, notificationContainer, bulletCount, pingText, wallCount) {
